...
const ProjectBox: FC<ProjectBoxProps> = ({ title, description, imageUrl }) => (
    ...
    >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full p-6">
            <h3 className="text-2xl text-white text-center font-bold mb-2 group-hover:text-white transition-colors duration-300">
                {title}
            </h3>
            <p className="text-gray-700 opacity-0 group-hover:opacity-100 group-hover:text-white transition-opacity duration-300 text-center">
                {description}
            </p>
        </div>
    </div>
