...
const Footer = () => {
  ...
  return (
    <footer className=" w-full flex flex-col items-center justify-center border-t-2 border-gray-200">
      {/* Logo + Nom */}
      <div className="flex flex-col md:flex-row items-center justify-around w-full mb-4">
      ...
      <div className="flex flex-col items-center md:items-start justify-center gap-y-1.5">
        <h2 className="text-xl lg:text-3xl font-bold text-black dark:text-white ">Liens</h2>
        <div className="flex flex-row md:flex-col max-sm:gap-x-11">
        <Link
          to="/"
          className="text-sm text-gray-800 dark:text-white font-semibold hover:underline"
        >
          Home
        </Link>
        <Link
        ...
        <div className="flex flex-col items-center md:items-start gap-3">
          <h2 className="text-xl text-black dark:text-white lg:text-3xl font-bold">Contacts</h2>
        ...
        {/* Adresse */}
        <div className="flex flex-col items-center md:items-start gap-3">
          <h2 className="text-xl text-black dark:text-white lg:text-3xl font-bold">Adresse</h2>
          <div className="flex flex-row md:flex-col gap-1 max-sm:gap-x-11">
            <a
        ...
        <div className="flex flex-col items-center gap-1.5">
          <h2 className="text-xl lg:text-3xl font-bold text-black dark:text-white ">Suivez-nous</h2>
          <div className="flex items-center md:gap-x-5 gap-x-11">
            <a
              href="#" target="_blank" rel="noopener noreferrer"
              className="text-gray-700 dark:text-white hover:text-blue-600 transition-transform duration-200 hover:scale-110"
            >
              <Facebook className="h-6 w-6 max-sm:h-8 max-sm:w-8" />
            </a>
            <a
              href="#" target="_blank" rel="noopener noreferrer"
              className="text-gray-700 dark:text-white hover:text-pink-500 transition-transform duration-200 hover:scale-110"
            >
              <Instagram className="h-6 w-6 max-sm:h-8 max-sm:w-8" />
            </a>
            <a
              href="#" target="_blank" rel="noopener noreferrer"
              className="text-gray-700 dark:text-white hover:text-sky-500 transition-transform duration-200 hover:scale-110"
            >
