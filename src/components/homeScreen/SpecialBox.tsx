...
const SpecialBox: FC<SpecialBoxProps> = ({ titre, icones, details }) => {
    return (
        <div className="flex flex-col h-40 my-2 border-t-4 border-black p-4 bg-white text-black transition-colors duration-300 relative cursor-pointer group hover:bg-black hover:text-white focus-within:bg-black focus-within:text-white">
            <div className="flex flex-row items-center justify-between">
                <span className="font-bold text-lg">{titre}</span>
